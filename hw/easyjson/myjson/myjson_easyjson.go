...
func easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson(in *jlexer.Lexer, out *CurrencyAmount) {
...
func easyjson1a3d1914EncodeGoplIoHwEasyjsonMyjson(out *jwriter.Writer, in CurrencyAmount) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v CurrencyAmount) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1a3d1914EncodeGoplIoHwEasyjsonMyjson(&w, v)
...
func (v *CurrencyAmount) UnmarshalJSON(data []byte) error {
	...
	easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CurrencyAmount) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson(l, v)
}
func easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson1(in *jlexer.Lexer, out *AccountBalance) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1a3d1914EncodeGoplIoHwEasyjsonMyjson1(out *jwriter.Writer, in AccountBalance) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v AccountBalance) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1a3d1914EncodeGoplIoHwEasyjsonMyjson1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *AccountBalance) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AccountBalance) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1a3d1914DecodeGoplIoHwEasyjsonMyjson1(l, v)
}
